...
namespace HOLYBIRDAPP.DAO
{
    class DataProvider
    {
        ...
        private string connectionStr = @"server=DESKTOP-UU88J58\SQLEXPRESS;database=HOLYBIRD_DOAN2;Integrated Security=True";
        ...
        public DataSet ExecuteQueryy(string query, object[] parameter = null)
        {
